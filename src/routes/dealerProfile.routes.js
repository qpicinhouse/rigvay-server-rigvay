...
router.post('/create-profile', authMiddleware, upload.single('profileImage'), createDealerProfile);
...
router.put('/update-profile', authMiddleware, upload.single('profileImage'), updateDealerProfile);
